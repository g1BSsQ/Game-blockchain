    ...
    return (
      <div className="bg-black">
        ...
        <section className="mt-4 mx-4 rounded-xl bg-gradient-to-r from-purple-700 to-purple-500 py-16 px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to Brutato Games</h1>
          <p className="mb-8">Experience the future of gaming on the Cardano blockchain</p>
          <Link href="/Game">
        ...
        <section className="mt-12 px-4 grid grid-cols-1 md:grid-cols-3 gap-6 pb-12">
          ...
          <div className="bg-gray-900 rounded-lg p-8 text-center">
            ...
            <h2 className="text-xl font-bold mb-4">Immersive Gameplay</h2>
          ...
          <div className="bg-gray-900 rounded-lg p-8 text-center">
            ...
            <h2 className="text-xl font-bold mb-4">Play-to-Earn</h2>
            <p className="text-gray-400">Earn real value while you play. Your skills translate to tangible rewards.</p>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-8 text-center">
            ...
            <h2 className="text-xl font-bold mb-4">Vibrant Community</h2>
            <p className="text-gray-400">Join thousands of players in a thriving ecosystem of gamers and creators.</p>
          </div>
        </section>
      </div>
    );
